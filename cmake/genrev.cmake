...
if(WITHOUT_GIT)
  set(rev_date "2019-04-23 16:00:00 -5000")
  set(rev_hash "LegionCore")
  set(rev_branch "Released")
else()
  if(GIT_EXECUTABLE)
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"LegionCore 2019-04-23 16:00:00 (Released)\"")
    set(rev_date "2019-04-23 16:00:00 -5000")
    set(rev_hash "LegionCore")
    set(rev_branch "Released")
  else()
