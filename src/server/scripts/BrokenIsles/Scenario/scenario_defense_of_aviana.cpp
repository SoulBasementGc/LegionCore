        ...
        switch (events.ExecuteEvent())
        {
            case DATA_STEP_1:
            {
                ...
                if (talkednpc)
                {
                    ...
                    InstanceScript::m_ScenarioStep = DATA_STEP_2;
            ...
            case DATA_STEP_2:
            {
                if (m_targetMobs.size() == 0)
                {
                    ...
                    InstanceScript::m_ScenarioStep = DATA_STEP_3;
                    SetData(DATA_SKYLORD_SHADEGROVE, IN_PROGRESS);
            ...
            case DATA_STEP_3:
            {
                ...
                if (backtopos)
                {
                    ...
                    InstanceScript::m_ScenarioStep = DATA_STEP_4;
                    SetData(DATA_SKYLORD_SHADEGROVE, IN_PROGRESS);
            ...
            case DATA_STEP_4:
            {
                if (Creature* creaturenpc = instance->GetCreature(GUID_SKYLORD_SHADEGROVE))
                {
                    creaturenpc->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_NON_ATTACKABLE);
                    ...
                    //creaturenpc->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE| UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_IMMUNE_TO_PC);
                }
            ...
            case DATA_STEP_5:
            {
                InstanceScript::m_ScenarioStep = DATA_STEP_5;
                SetData(DATA_SKYLORD_SHADEGROVE, DONE);
                break;
            }
        }
